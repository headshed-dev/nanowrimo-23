...
- {{renderer :wordcount_}}
	...
	- It is prefereable in my view to adopt core principles in the way that we do things in order to learn from our and others before us mistakes. This way we are less likely to fall foul of some of the disasters that are otherwise