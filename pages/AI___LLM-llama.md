- {{renderer :wordcount_}}
	...
	- I understand that llama2 and other models can be augmented, trained if you would, but I came across a tool on Github that wraps this for you into an application