- {{renderer :wordcount_}}
	...
	- I understand that llama2 and other models can be augmented, trained if you would, but I came across a tool on Github that wraps this for you into an application that calls itself [ollama](https://github.com/jmorganca/ollama), which is written in Go but has some bash scriptery that helps install